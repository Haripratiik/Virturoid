    ...
    if method == "initialize":
        return {"protocolVersion": PROTOCOL_VERSION,
                ...
                "instructions": (
                    ...
                    "assembler + state machine + safety filter + watchdog control stack.\n"
                    ...
                    "payload' into typed materials/payload, APPLIES them, and holds ONE editable robot ready to "
                    "verify/edit), interpret_prompt (provenance for "
